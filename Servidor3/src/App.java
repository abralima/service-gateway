...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            Registry registro = LocateRegistry.getRegistry(5003);

            registro.bind("servidor3", skeleton);
            ...
            registro3 = LocateRegistry.getRegistry("localhost", 5001);

            replica3 = (IServidor) registro3.lookup("servidor");
